...
import backgroundImage from "../../assets/tech-consulting-bg.jpg";
    ...
    >
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 py-24">
        <div className="text-center max-w-5xl mx-auto w-full">
          ...
          <h1
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-12
          ...
          <div
            className="backdrop-blur-xl bg-white/10 rounded-3xl p-10 sm:p-12 md:p-16 border border-white/20
          ...
          >
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
              ...
              <strong className="text-[#fdba74]">
                align your technology with your vision
              </strong>
              . From startups to enterprises, we audit your stack, eliminate
              bottlenecks, and architect the future.
            </p>
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed mb-8">
              Cloud migration • Cybersecurity hardening • Team upskilling • Tool
              selection • Digital transformation roadmaps — all built for
              African scale and global ambition.
            </p>

            <hr className="border-[#fdba74]/50 my-12 w-1/2 mx-auto" />

            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed">
              The result? A business that doesn’t just survive the digital age —
              it <strong className="text-[#fdba74]">dominates it</strong>.
            </p>
          </div>
