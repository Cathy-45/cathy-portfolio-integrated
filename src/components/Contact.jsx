...
const Contact = () => {
  return (
    ...
    >
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-8xl font-poppins font-bold mb-4 sm:mb-6 text-[#fdba74] text-center">
        Thank you for visiting!
      </h2>
      <p className="text-xl sm:text-2xl md:text-3xl font-roboto text-white text-center mb-6">
        Have a project or question? Let’s discuss how I can help
      </p>
      <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 mb-6">
        <p className="text-xl sm:text-2xl md:text-3xl font-roboto text-white text-center">
          Email:{" "}
